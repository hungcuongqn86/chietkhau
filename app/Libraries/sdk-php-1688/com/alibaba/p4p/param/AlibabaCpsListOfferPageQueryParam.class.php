...
537357997672</pre>     
    ...
    */
     ...
     * 参数示例：<pre>销量：saleQuantity^asc;价格：price^desc;推广量：tkCnt^desc;分佣比例：ratio^desc;月支出佣金：tkCommission^desc;优惠券面值：yhqDiscountFee^desc;老买家分佣比例：oldBuyerRatio^desc;</pre>     
     * 此参数必填     */
    ...
    */
    ...
    public function setPageSize( $pageSize) {
        ...
        /**
    * @return 老买家佣金比例筛选，注意这里与ratio格式不同，用~分割上下区间，如0.1~:表示大于等于0.1;~0.2:表于小于等于0.2;0.2~0.3:表示0.2到0.3
    */
        public function getFilterOldBuyerRatio() {
        $tempResult = $this->sdkStdResult["filterOldBuyerRatio"];
        return $tempResult;
    }
    
    /**
     * 设置老买家佣金比例筛选，注意这里与ratio格式不同，用~分割上下区间，如0.1~:表示大于等于0.1;~0.2:表于小于等于0.2;0.2~0.3:表示0.2到0.3     
     * @param String $filterOldBuyerRatio     
     * 参数示例：<pre>0.2~0.3</pre>     
     * 此参数必填     */
    public function setFilterOldBuyerRatio( $filterOldBuyerRatio) {
        $this->sdkStdResult["filterOldBuyerRatio"] = $filterOldBuyerRatio;
    }
